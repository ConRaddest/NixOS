...
FloatingWindow {
    ...
    ListPreviewPicker {
        ...
        itemMatches: function (item, q) {
            return item.display.toLowerCase().includes(q) || item.details.toLowerCase().includes(q);
        }
        isImage: function (item) {
            return item && item.isImage;
        }
        imageSource: function (item) {
            return clipboardWindow.previewImage;
        }
        previewText: function (item) {
            return clipboardWindow.previewText;
        }
